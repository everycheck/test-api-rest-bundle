...
namespace EveryCheck\TestApiRestBundle\Tests\sampleProject\src\PatternBundle\Service;
...
class Api{
	...
	public function postPattern(array $demo)
	{
		$response = $this->guzzleClient->request("POST", "/pattern/new", $this->getOption($demo));
